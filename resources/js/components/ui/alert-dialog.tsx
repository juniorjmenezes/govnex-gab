...
function AlertDialogContent({
  ...
  return (
    <AlertDialogPortal>
      <AlertDialogOverlay />
      {/* Mesma razão do dialog: translate de 50% em dimensão ímpar borra as
          bordas de 1px de dentro do alerta. */}
...
function AlertDialogTitle({
  ...
  return (
    <AlertDialogPrimitive.Title
      ...
      className={cn(
        "text-xs font-semibold tracking-wide text-foreground uppercase sm:group-data-[size=default]/alert-dialog-content:group-has-data-[slot=alert-dialog-media]/alert-dialog-content:col-start-2",
        className
      )}
      {...props}
    />
