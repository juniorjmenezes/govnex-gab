...
const drawerPopupSideClasses = {
  right:
    "h-full w-full max-w-md rounded-2xl data-closed:slide-out-to-right-8 data-open:slide-in-from-right-8",
  ...
  bottom:
    "w-full max-h-[85vh] rounded-t-2xl data-closed:slide-out-to-bottom-8 data-open:slide-in-from-bottom-8",
} as const
  ...
  return (
    <DrawerPrimitive.Portal>
      <DrawerPrimitive.Backdrop
        ...
        className="fixed inset-0 z-50 bg-black/20 duration-100 supports-backdrop-filter:backdrop-blur-sm data-closed:animate-out data-closed:fade-out-0 data-open:animate-in data-open:fade-in-0"
      />
      ...
      >
        <DrawerPrimitive.Popup
          ...
          className={cn(
            "flex flex-col bg-popover text-popover-foreground shadow-md ring-1 ring-foreground/10 outline-none duration-200 data-closed:animate-out data-closed:fade-out-0 data-open:animate-in data-open:fade-in-0",
