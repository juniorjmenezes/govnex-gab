 ...
 * (ver `AttachmentField`, em forms/attachment-field.tsx). Clique ou arraste
 * disparam `onFiles`/`onClick`; o conteúdo (prévia, ícone, texto) fica a
 * cargo de quem usa o componente.
 */
