...
/**
 * Sem campo de situação: um encaminhamento é um evento, não um registro com
 * estado próprio. Só o destino é obrigatório — o resto é preenchido quando
 * fizer sentido.
 */
class StoreDemandReferralRequest extends FormRequest
{
